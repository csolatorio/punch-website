  ...
  return (
    <div className="relative w-full h-screen text-white">
      ...
      >
        ...
        <div className="relative max-w-6xl text-black text-left p-8 ml-12 md:ml-6 sm:ml-4 sm:p-6">
          <h1 className="text-9xl md:text-7xl sm:text-4xl font-semibold mb-8">
