  ...
  return (
    <div className="relative w-full min-h-screen text-white">
      ...
      >
        ...
        <div className="relative max-w-6xl text-black text-left p-8 ml-12 lg:ml-10 md:ml-6 sm:ml-4 sm:p-4">
          <h1 className="text-6xl lg:text-8xl md:text-3xl sm:text-2xl font-semibold mb-8 leading-tight">
            A Boxing Workout That Hits Different
          </h1>
          <p className="text-lg md:text-base sm:text-sm mb-8 leading-relaxed">
